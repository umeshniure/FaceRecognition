...
cv.rectangle(imgTest, (test_face_location[3], test_face_location[0]), (test_face_location[1], test_face_location[2]),
             (0, 255, 0), thickness=3)
...
cv.putText(imgTest, f'{recognized} {round(face_difference[0], 2)}', (10, 20), cv.FONT_HERSHEY_SIMPLEX, 0.7, (0, 255, 0),
           2)
